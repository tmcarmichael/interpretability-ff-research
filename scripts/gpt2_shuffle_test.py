"""Shuffled-label control for the GPT-2 124M probe.

Trains probes with randomly permuted binary targets at the GPT-2 124M peak
layer. Provides a null distribution for partial correlation to confirm the
